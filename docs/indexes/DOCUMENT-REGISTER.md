...
| IDX-001 | KRONOS Document Register | Repository Index | P0 | Draft | Repository Publication | None | None | None | Chief Architect Office | Chief Architect | `docs/indexes/DOCUMENT-REGISTER.md` | Version: 0.2; Canonical Status: Draft; Repository Synchronization: Completed |
...
| ADR-009 | Provider-Bounded Instrument Master Acquisition Architecture | Architecture Decision Record | P0 | Approved | Repository Publication | None | None | None | Chief Architect | Chief Architect | `docs/architecture/platform/domains/provider/ADR-009-PROVIDER-BOUNDED-INSTRUMENT-MASTER-ACQUISITION-ARCHITECTURE.md` | Version: 1.0; Canonical Status: Canonical; Approved By: Chief Architect; Activation State: Inactive — Pending Chief Architect Activation Review; Implementation Authorization: None; Runtime Impact: None; EDD-004 Drafting Authorization: None; Provider Endpoint Invocation Authority: None; Persistence Authority: None |
| MIG-001 | ADR-009 Coordinated Architecture Migration Package | Migration Package | P0 | Approved | Repository Publication | None | None | None | Chief Architect | Chief Architect | `docs/architecture/migrations/MIG-001-ADR-009-COORDINATED-ARCHITECTURE-MIGRATION-PACKAGE.md` | Version: 0.2; Canonical Status: Canonical; Governing Architecture: ADR-009 Version 1.0; Architecture Migration: Completed; Engineering Publication: Completed; Repository Synchronization: Completed; Activation State: Inactive — Pending Chief Architect Activation Review; Implementation Authorization: None; Runtime Authority: None; EDD-004 Drafting Authorization: None |
...
| EAIC-002 | Provider → Instrument Submission Contract | Interface Contract | P0 | Approved | Repository Publication | None | None | None | Chief Architect | Chief Architect | `docs/architecture/interfaces/EAIC-002-PROVIDER-TO-INSTRUMENT-SUBMISSION-CONTRACT.md` | Version: 0.1; Canonical Status: Canonical; Governing Architecture: ADR-009 Version 1.0; Governing Migration Package: MIG-001 Version 0.1; Document Activation State: Inactive — Pending Coordinated Migration and Separate Activation Authorization; RC-03 Migration Condition: Completed; Current Activation: Pending Chief Architect Activation Review; Migration Execution Authority: None; Implementation Authority: None; Runtime Authority: None; Provider Endpoint Invocation Authority: None; Persistence Authority: None; EDD-004 Drafting Authority: None; Product Activation Authority: None |
