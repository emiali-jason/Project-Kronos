...
class DiscoveryOperationAccounting:
    ...
    def __post_init__(self) -> None:
        ...
        if self.actual_provider_requests is None:
            ...
            or tuple(x[0] for x in self.request_categories) != tuple(ProviderRequestCategory)
...
def create_operation_accounting(**values) -> DiscoveryOperationAccounting:
    core = dict(values, contract_identity="KRONOS-INTRADAY-DISCOVERY-OPERATION-ACCOUNTING", contract_version="1.0.0")
