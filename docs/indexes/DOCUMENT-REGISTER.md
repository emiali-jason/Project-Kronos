...
| ADR-009 | Provider-Bounded Instrument Master Acquisition Architecture | Architecture Decision Record | P0 | Approved | Repository Publication | None | None | None | Chief Architect | Chief Architect | `docs/architecture/platform/domains/provider/ADR-009-PROVIDER-BOUNDED-INSTRUMENT-MASTER-ACQUISITION-ARCHITECTURE.md` | Version: 1.0; Canonical Status: Canonical; Approved By: Chief Architect; Activation State: Pending Coordinated Migration; Implementation Authorization: None; Runtime Impact: None; EDD-004 Drafting Authorization: None; Provider Endpoint Invocation Authority: None; Persistence Authority: None |
| MIG-001 | ADR-009 Coordinated Architecture Migration Package | Migration Package | P0 | Approved | Repository Publication | None | None | None | Chief Architect | Chief Architect | `docs/architecture/migrations/MIG-001-ADR-009-COORDINATED-ARCHITECTURE-MIGRATION-PACKAGE.md` | Version: 0.1; Canonical Status: Canonical; Governing Architecture: ADR-009 Version 1.0; Activation State: Planning Only; Migration Execution Authorization: None; Implementation Authorization: None; Runtime Authority: None; EDD-004 Drafting Authorization: None |
