...
| EDD-004 | Provider Instrument Master Acquisition Engineering Design | Engineering Design Document | P0 | Draft | Draft Preparation | None | Draft Authorized | None | Engineering Design Team | Chief Architect | `docs/engineering/edd/EDD-004-PROVIDER-INSTRUMENT-MASTER-ACQUISITION-ENGINEERING-DESIGN.md` | Version: 0.4; Canonical Status: Draft; Engineering Stage: Engineering Interface Architecture; Engineering Authority: Draft Preparation; Draft Preparation Approved with Constraints by CAR-003 under RC-04; ES-01 Engineering Scope Definition preserved as the frozen baseline; ES-02 Engineering Capability Decomposition preserved as the authoritative 11-capability baseline; ES-03 Engineering Building Block Architecture preserved as the authoritative 14-building-block baseline; ES-04 Engineering Interface Architecture published as the authoritative 14-interface baseline for subsequent EDD-004 engineering design; Governing Architecture: ADR-009 Version 1.0; Governing Interface: EAIC-002 Version 0.1; Governing Engineering Baseline: EAP-001 through EAP-006; Approval State: Not Approved; Implementation Authorization: None; Runtime Authority: None |
