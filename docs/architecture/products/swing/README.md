...
The architecture migration, engineering publication, repository synchronization, and RC-04 activation are complete. The published baseline is active for constrained Engineering Design, and EDD-004 Draft Preparation is Approved with Constraints. Implementation and runtime activity remain unauthorized.
...
- [ADP-001C — Provider → Instrument Contract](SWING-PHASE-1-PROVIDER-INSTRUMENT-CONTRACT.md) — Superseded historical predecessor; [EAIC-002 Version 0.1](../../interfaces/EAIC-002-PROVIDER-TO-INSTRUMENT-SUBMISSION-CONTRACT.md) is the Operational Canonical Provider → Instrument Contract under RC-04
...
- [MCX-CONTEXT-01 — Twice-Daily Supporting Context V1](KRONOS-SWING-MCX-CONTEXT-01-TWICE-DAILY-SUPPORTING-CONTEXT-V1.md) — Approved immutable MORNING/EVENING MCX visual-context evidence with no analytical or trading authority
