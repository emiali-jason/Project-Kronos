...
| ADR-0020 — Intraday WO-11 to WO-12 KR-370 Analytical Promotion Boundary | Historical V1 boundary; exact crossing and common KR-370 reuse remain active while its Intraday five-criterion/K5 clauses are superseded by ADR-0021 | Approved — superseded in part | Chief Architect / KR-370 / DOMAIN-003 Validation | [`adr/ADR-0020-INTRADAY-WO11-WO12-KR370-ANALYTICAL-PROMOTION-BOUNDARY.md`](adr/ADR-0020-INTRADAY-WO11-WO12-KR370-ANALYTICAL-PROMOTION-BOUNDARY.md) |
| ADR-0021 — Intraday WO-12 Four-Criterion Promotion and WO-15 Extension Ownership | Historical WO-12 V2 authority and current WO-15 execution-time/entry-relative extension authority; prospective promotion ownership is superseded by ADR-0038 | Approved — superseded in part | Chief Architect / KR-370 / DOMAIN-003 Validation | [`adr/ADR-0021-INTRADAY-WO12-FOUR-CRITERION-PROMOTION-AND-WO15-EXTENSION-OWNERSHIP.md`](adr/ADR-0021-INTRADAY-WO12-FOUR-CRITERION-PROMOTION-AND-WO15-EXTENSION-OWNERSHIP.md) |
| ADR-0038 — Intraday WO-09 Governed Promotion and Active Readiness | Prospective five-criterion promotion/readiness ownership from immutable WO-07F lineage, separate from WO-15 execution-time extension | Approved | Sponsor / Executive Architect | [`adr/ADR-0038-INTRADAY-WO09-GOVERNED-PROMOTION-AND-ACTIVE-READINESS.md`](adr/ADR-0038-INTRADAY-WO09-GOVERNED-PROMOTION-AND-ACTIVE-READINESS.md) |
| ADR-0022 — Intraday WO-12 to WO-13 Step-31 Trade Construction Boundary | Current Intraday WO-13 authority for exact NOW admission, immutable 15M setup-specific geometry, one Target, model R:R, availability and core engineering after governance publication | Approved | Chief Architect / KRONOS Intraday / Step-31 | [`adr/ADR-0022-INTRADAY-WO12-WO13-STEP31-TRADE-CONSTRUCTION-BOUNDARY.md`](adr/ADR-0022-INTRADAY-WO12-WO13-STEP31-TRADE-CONSTRUCTION-BOUNDARY.md) |
| ADR-0023 — Intraday DOMAIN-007 Advisory Risk Observation Boundary | Current Intraday WO-14 authority for advisory loss-exposure observation with no trade veto, geometry, quantity, timing, Sponsor or broker authority; Swing Risk permission remains unchanged | Approved | Chief Architect / DOMAIN-007 / KRONOS Intraday | [`adr/ADR-0023-INTRADAY-DOMAIN-007-ADVISORY-RISK-OBSERVATION-BOUNDARY.md`](adr/ADR-0023-INTRADAY-DOMAIN-007-ADVISORY-RISK-OBSERVATION-BOUNDARY.md) |
| ADR-0024 — Swing Step-31 Forward Target Eligibility Governance | Successor Swing target-eligibility policy requiring strict positive forward reward against immutable rounded Entry, preserving rejected structural context with no fallback | Approved — publication pending | EA-SWING / Sponsor | [`adr/ADR-0024-SWING-STEP31-FORWARD-TARGET-ELIGIBILITY-GOVERNANCE.md`](adr/ADR-0024-SWING-STEP31-FORWARD-TARGET-ELIGIBILITY-GOVERNANCE.md) |
| ADR-0025 — Intraday WO-15 / KR-380 Completed-5M Entry Timing Boundary | Completed-governed-5M timing authority, immutable cycle/state grammar, research-only extension telemetry and versioned downstream handoff with WO-13 geometry and WO-14 non-veto preserved | Approved — publication pending | Chief Architect / KR-380 / DOMAIN-004 / KRONOS Intraday | [`adr/ADR-0025-INTRADAY-WO15-KR380-COMPLETED-5M-ENTRY-TIMING-BOUNDARY.md`](adr/ADR-0025-INTRADAY-WO15-KR380-COMPLETED-5M-ENTRY-TIMING-BOUNDARY.md) |
| ADR-0026 — Intraday WO-16 Sponsor Decision and Session-Bounded Lifecycle Admission | Exact current WO-13/14/15 and DOMAIN-008 bound PAPER/LIVE/IGNORE decision receipt plus separate factual admission, with no position, fill, Risk-veto or broker authority | Approved — publication pending | Sponsor / KRONOS Intraday Engineering Architect | [`adr/ADR-0026-INTRADAY-WO16-SPONSOR-DECISION-AND-SESSION-BOUNDED-LIFECYCLE-ADMISSION.md`](adr/ADR-0026-INTRADAY-WO16-SPONSOR-DECISION-AND-SESSION-BOUNDED-LIFECYCLE-ADMISSION.md) |
| ADR-0027 — Intraday WO-17 Position Evidence and Active Lifecycle Monitoring | PAPER model-entry and LIVE Sponsor-attestation position evidence, subject-scoped cardinality and read-only lifecycle monitoring with no broker or economics authority | Approved — publication pending | Sponsor / KRONOS Intraday Engineering Architect | [`adr/ADR-0027-INTRADAY-WO17-POSITION-EVIDENCE-AND-ACTIVE-LIFECYCLE-MONITORING.md`](adr/ADR-0027-INTRADAY-WO17-POSITION-EVIDENCE-AND-ACTIVE-LIFECYCLE-MONITORING.md) |
| ADR-0028 — DOMAIN-008 MCX Cross-Schedule Compatibility | Immutable directional proof that an exact family-specific MCX expiry schedule specializes an exact governed base schedule, with no roll, analytical or trading authority | Approved — engineering validation pending | Chief Architect / DOMAIN-008 | [`adr/ADR-0028-DOMAIN-008-MCX-CROSS-SCHEDULE-COMPATIBILITY.md`](adr/ADR-0028-DOMAIN-008-MCX-CROSS-SCHEDULE-COMPATIBILITY.md) |
| ADR-0029 — Intraday WO-B Operational Readiness Review | Read-only cross-domain composition, immutable review snapshots and projection-only current pointers without a second lifecycle or trading authority | Approved — publication pending | Chief Architect / KRONOS Intraday | [`adr/ADR-0029-INTRADAY-WO-B-OPERATIONAL-READINESS-REVIEW.md`](adr/ADR-0029-INTRADAY-WO-B-OPERATIONAL-READINESS-REVIEW.md) |
| Intraday WO-12 KR-370 Analytical Promotion V1 | Historical immutable product architecture for 15M K1–K5 and V1 artifacts | Approved Architecture — historical V1 | KR-370 / DOMAIN-003 Validation | [`products/intraday/KRONOS-INTRADAY-WO-12-KR370-ANALYTICAL-PROMOTION-V1.md`](products/intraday/KRONOS-INTRADAY-WO-12-KR370-ANALYTICAL-PROMOTION-V1.md) |
| Intraday WO-12 KR-370 Analytical Promotion V2 | Historical product architecture retained under its original policy; prospective current ownership superseded by WO-09/ADR-0038 | Approved Architecture — historical current-state predecessor | KR-370 / DOMAIN-003 Validation | [`products/intraday/KRONOS-INTRADAY-WO-12-KR370-ANALYTICAL-PROMOTION-V2.md`](products/intraday/KRONOS-INTRADAY-WO-12-KR370-ANALYTICAL-PROMOTION-V2.md) |
| Intraday WO-09 Governed Promotion and Active Readiness | Prospective exact-WO-07F five-criterion readiness, attention, reassessment and next-WO eligibility authority | Approved engineering candidate | KRONOS Intraday / WO-09 | [`products/intraday/KRONOS-INTRADAY-WO-09-GOVERNED-PROMOTION-AND-ACTIVE-READINESS.md`](products/intraday/KRONOS-INTRADAY-WO-09-GOVERNED-PROMOTION-AND-ACTIVE-READINESS.md) |
| Intraday WO-13 Step-31 Trade Construction V1 | Current product architecture for exact WO-12 NOW admission and immutable 15M pullback/range-breakout geometry with no Risk or timing authority | Approved Architecture — Governance Published; Bounded Core Engineering Authorized | KRONOS Intraday / Step-31 | [`products/intraday/KRONOS-INTRADAY-WO-13-STEP31-TRADE-CONSTRUCTION-V1.md`](products/intraday/KRONOS-INTRADAY-WO-13-STEP31-TRADE-CONSTRUCTION-V1.md) |
| Intraday WO-14 DOMAIN-007 Risk Observation V1 | Advisory Intraday loss-exposure observation contract, state vocabulary, market-family treatment, unresolved policy and exact WO-13 source dependency | Approved Architecture — Source Engineering Gated on WO-13 Contracts | DOMAIN-007 / KRONOS Intraday | [`products/intraday/KRONOS-INTRADAY-WO-14-DOMAIN-007-RISK-OBSERVATION-V1.md`](products/intraday/KRONOS-INTRADAY-WO-14-DOMAIN-007-RISK-OBSERVATION-V1.md) |
| Intraday WO-15 KR-380 Entry Timing V1 | Completed-5M timing grammar, immutable cycles/transitions, extension research telemetry and timing-handoff trust boundary | Approved Architecture — Publication Pending; Source Engineering Not Authorized | KR-380 / DOMAIN-004 / KRONOS Intraday | [`products/intraday/KRONOS-INTRADAY-WO-15-KR380-ENTRY-TIMING-V1.md`](products/intraday/KRONOS-INTRADAY-WO-15-KR380-ENTRY-TIMING-V1.md) |
| Intraday WO-16 Sponsor Decision and Session-Bounded Lifecycle Admission V1 | Product-local decision/admission architecture that consumes exact current WO-13/14/15 and DOMAIN-008 evidence without creating a position or execution fact | Approved Architecture — Publication Pending; Source Engineering Not Authorized | KRONOS Intraday | [`products/intraday/KRONOS-INTRADAY-WO-16-SPONSOR-DECISION-AND-LIFECYCLE-ADMISSION-V1.md`](products/intraday/KRONOS-INTRADAY-WO-16-SPONSOR-DECISION-AND-LIFECYCLE-ADMISSION-V1.md) |
| Intraday WO-17 Position Evidence and Active Lifecycle Monitoring V1 | Product-local PAPER model-position and Sponsor-attested LIVE position truth, read-only monitoring, immutable events and fail-closed recovery | Approved Architecture — Publication Pending; Source Engineering Not Authorized | KRONOS Intraday | [`products/intraday/KRONOS-INTRADAY-WO-17-POSITION-EVIDENCE-AND-ACTIVE-LIFECYCLE-MONITORING-V1.md`](products/intraday/KRONOS-INTRADAY-WO-17-POSITION-EVIDENCE-AND-ACTIVE-LIFECYCLE-MONITORING-V1.md) |
| Intraday WO-B Operational Readiness Review V1 | Product-local read-only composition of exact producer states into immutable multi-state review snapshots and projection-only current aliases | Approved Architecture — Publication Pending; WO-B1 Engineering Authorized | KRONOS Intraday | [`products/intraday/KRONOS-INTRADAY-WO-B-OPERATIONAL-READINESS-REVIEW-V1.md`](products/intraday/KRONOS-INTRADAY-WO-B-OPERATIONAL-READINESS-REVIEW-V1.md) |
...
## PERF/LAG-01 read-mechanics engineering

**Status:** Sponsor/EA authorized engineering; release separately gated.
[ADR-0055](adr/ADR-0055-PERF-LAG-01-VALIDATED-READ-REUSE.md) records bounded exact-byte
validation reuse and single-population presentation. It preserves current-pointer,
