...
| Relative-volume methodology | Volume consequence remains shadow/deferred | WO-06 participation and outcome evidence | WO-06 Part 2/3 | Intraday/CA |
| Nearest-barrier selection | `BARRIER_SELECTION_METHODOLOGY_REQUIRED`; selection consequence is unproven | Barrier/path outcome evidence | WO-06 Part 3 | Intraday/CA |
| Population target or methodology change from population buckets | V0 accepts natural population and buckets have no admission authority | PAPER observation and separately governed successor evidence | Successor methodology only | Intraday/CA |
