...
| KR-260B | Retrieve market data from those symbols. | Future standardized OHLCV retrieval, retrieval availability, status, and reasons | Symbol routing, normalization, indicators, intelligence, decisions, alerts, or trade management | KR-260A public routing outputs | Future retrieved market-data interface | Future KR-260 normalization |
