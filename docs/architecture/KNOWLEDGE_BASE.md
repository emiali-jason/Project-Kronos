...
| Intraday WO-13 Step-31 Trade Construction V1 | Current product architecture for exact WO-12 NOW admission and immutable 15M pullback/range-breakout geometry with no Risk or timing authority | Approved Architecture — Governance Publication Required Before Core Engineering | KRONOS Intraday / Step-31 | [`products/intraday/KRONOS-INTRADAY-WO-13-STEP31-TRADE-CONSTRUCTION-V1.md`](products/intraday/KRONOS-INTRADAY-WO-13-STEP31-TRADE-CONSTRUCTION-V1.md) |
