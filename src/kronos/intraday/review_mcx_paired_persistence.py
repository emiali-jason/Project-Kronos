...
class IntradayMcxPairedReviewStore:
    ...
    def retain_transport_pointer(self, value: McxPairedReviewTransport) -> Path:
        ...
        namespace = "pack-transports-family" if value.schema_version == "1.4.0" else "pack-transports-temporal" if value.schema_version == "1.3.0" else "pack-transports-analyst" if value.schema_version == "1.2.0" else "pack-transports-pdf-only" if value.schema_version == "1.1.0" else "pack-transports"
