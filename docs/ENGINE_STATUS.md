...
| KR-360 | Confidence Engine | Synthesizes prior public outputs into explainable confidence. | `1.0.0` | `FROZEN` | Frozen | Public outputs from KR-300, KR-310, KR-315, KR-320, KR-330, KR-340, and KR-350; KR-335 is not consumed in this release | Confidence readiness, 0-100 score, state/text/reason, classification flags | KR-370; KR-380; KR-705 | Static review confirms score clamping and public-output-only architecture. Source and repository history agree on Frozen. |
