...
| KR-370 / Intraday WO-09 | How close is an exact WO-07F-valid opportunity to analytical promotion? | Five-criterion governed promotion/readiness, outstanding requirements, Sponsor attention and lawful reassessment | Entry timing, Entry Outcomes, Risk approval, Sponsor decisions, positions, fills, stops, geometry, broker actions, or trade management | Exact immutable WO-07F lineage plus already-governed current machine and reconciled visual facts | NO_FOCUS, NEAR_READY, BUY/SELL_READY, BUY/SELL_NOW, hard-gate/unavailable states, requirements and next-WO handoff | Next-WO eligibility only; KR-705. WO-12 V1/V2 remains historical evidence. |
