...
| KR-250 | Asset Intelligence Engine | Maps the current instrument to asset identity, dependency profile, and reference symbol. | Not declared | Not declared | Foundation | KR-200 identity | Asset name/type/market/exchange, primary and reference symbols, dependency and trading profiles | KR-260; KR-380A; other market-aware consumers | Static review confirms Gold -> `COMEX:GC1!`, Silver -> `COMEX:SI1!`, Copper -> `COMEX:HG1!`; Energy mappings exist as planned-model scaffolding. |
| KR-252 | Market Relationship Engine | Exposes cash, sector, parent-index, and global-reference relationships for supported instruments. | `0.1.0` | `FOUNDATION` | Foundation | KR-251 support/model outputs; KR-250 asset identity | Relationship readiness/status/reason, cash/reference/sector/parent symbols, and context flags | Future market-relationship consumers; not wired into KR-260 yet | Configuration-only foundation. MCX Metals and Energy resolve validated global references; NSE remains structural REVIEW until curated relationships are generated. |
| KR-260 | Market Data Engine | Retrieves, validates, and standardizes primary and reference OHLCV across strategic, trend, structure, and execution timeframes. | `0.5.0-alpha` | Not declared | Foundation | KR-100 timeframe placeholders; KR-250 symbols/profiles; shared `getOHLCV()` | Primary/reference OHLCV datasets, availability flags, status and error text | KR-270; KR-275; KR-280; KR-300; KR-315; KR-380A; KR-390A | Static review confirms invalid placeholders are not passed as reference symbols and reference charts fall back to the chart symbol. Source status is absent. |
...
| KR-360 | Confidence Engine | Synthesizes prior public outputs into explainable confidence. | `1.0.0` | `FROZEN` | Frozen | Public outputs from KR-300, KR-310, KR-315, KR-320, KR-330, KR-340, KR-350 | Confidence readiness, 0-100 score, state/text/reason, classification flags | KR-370; KR-380; KR-705 | Static review confirms score clamping and public-output-only architecture. Source and repository history agree on Frozen. |
