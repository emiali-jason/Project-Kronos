...
VISUAL_IDENTITY_RELATIONSHIP_PUBLICATION_V1_MCX_REFERENCE_VERSION = "1.2.0"
VISUAL_IDENTITY_RELATIONSHIP_PUBLICATION_V1_REVIEW_VERSION = "1.3.0"
...
VISUAL_IDENTITY_REFERENCE_ANALYTICAL_SUBJECTS = (
    ...
    "REFERENCE-SUBJECT-COMEX-SILVER",
    "REFERENCE-SUBJECT-NYMEX-CRUDE-OIL",
    "REFERENCE-SUBJECT-NYMEX-NATURAL-GAS",
)
