...
| KR-380 Execution | versioned Entry Outcome, trigger flags, context flags | Entry Outcome reason, ref/MCX blocker outputs, execution needs | None | NO_TRIGGER/FORMING/LONG_ENTRY_TRIGGERED/SHORT_ENTRY_TRIGGERED/FAILED/EXTENDED | Upstream analytical promotion, Step-31 geometry, Risk, and execution-context gates are separate authorities | Partly | Yes, for exact entry-timing blocker contract |
