...
| EDD-004 | Provider Instrument Master Acquisition Engineering Design | Engineering Design Document | P0 | Draft | Draft Preparation | None | Draft Authorized | None | Engineering Design Team | Chief Architect | `docs/engineering/edd/EDD-004-PROVIDER-INSTRUMENT-MASTER-ACQUISITION-ENGINEERING-DESIGN.md` | Version: not yet assigned; Draft Preparation Approved with Constraints by CAR-003 under RC-04; draft file not created by RC-04A; Governing Architecture: ADR-009 Version 1.0; Governing Interface: EAIC-002 Version 0.1; Governing Engineering Baseline: EAP-001 through EAP-006; Implementation Authorization: None; Runtime Authority: None |
