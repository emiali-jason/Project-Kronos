...
| KR-251 | Market Model Configuration Engine | Classifies the chart into MCX Metals Swing, MCX Energy Swing, NSE Equity Swing, NSE Index Swing, or Unsupported and exposes execution semantics. | `0.1.0` | `FOUNDATION` | Foundation | KR-250 asset identity; curated NSE equity symbols; general NSE cash equity symbols; exact NIFTY/BANKNIFTY index symbols | Model name, asset name, analysis symbol, execution instrument text/type, venue, profile, cash symbol, support flag | KR-252; future KR-260A integration | Configuration Layer complete for current Swing models. Curated NSE equities retain Stock Futures semantics; non-curated NSE equities are Cash Only. No data retrieval is performed. |
| KR-252 | Market Relationship Engine | Exposes cash, sector, parent-index, and global-reference relationships for supported instruments. | `0.1.0` | `FOUNDATION` | Foundation | KR-251 support/model outputs; KR-250 asset identity; generated `data/nse/KRONOS_NSE_RELATIONSHIPS.csv` map; general NSE cash fallback | Relationship readiness/status/reason, cash/reference/sector/parent symbols, context flags, generated 91-stock NSE relationship map, and general NSE cash parent benchmark | Future market-relationship consumers; not wired into KR-260 yet | Configuration-only foundation. MCX Metals and Energy relationships are unchanged. Curated NSE Equity has 90 READY rows and 1 REVIEW row (`KAYNES`); non-curated NSE cash equities receive parent `NSE:NIFTY` and no sector context. NSE Index supports NIFTY and BANKNIFTY as relationship-ready context instruments. |
| KR-260A | Market Data Routing Engine | Selects the symbols and capabilities KRONOS should use for market data. | `0.1.0` | `FOUNDATION` | Foundation | KR-251 model/execution outputs; KR-252 relationship outputs | Route readiness/status/reason, analysis symbol, execution text, primary/secondary/sector/parent symbols, and capability flags | Future KR-260B retrieval | Routing only. Curated NSE equities retain sector and parent routing; non-curated NSE cash equities route cash analysis plus parent `NSE:NIFTY` without sector context. No `request.security()` calls or OHLCV retrieval are introduced. |
...
| Engine | Name | Single responsibility | Source version | Source status | Contract maturity | Inputs / dependencies | Public outputs summary | Downstream consumers | Validation scope and notes |
|---|---|---|---|---|---|---|---|---|---|
| KR-300 | Trend Foundation Engine | Classifies Daily trend direction and stage from price/SMA alignment. | `1.1.0` | `Foundation` | Foundation | KR-260 trend close; KR-270 trend SMA 20/50/200 | Trend readiness, direction, stage, SMA alignment, price-position states and flags | KR-310; KR-320; KR-330; KR-340; KR-341; KR-350; KR-705 | Included in repository-history intelligence-core freeze language while source remains Foundation. **Source metadata requires reconciliation.** |
...
| KR-341 | Consolidated Directional Bias Engine | Produces the authoritative Weekly/Daily/4H directional bias for swing-trading decisions. | `0.1.0` | `FOUNDATION` | Foundation | KR-260 existing Weekly and 4H datasets; KR-300 confirmed Daily trend-stage outputs | Consolidated directional readiness, state, text, reason, summary, bullish/bearish permission flags, neutral/conflict flags, and compatibility neutral-conflicted aggregate | KR-360; KR-370 | Weekly Neutral is permissive, Weekly opposite confirmed direction blocks, Confirmed Daily is mandatory for READY permission, and Developing Daily supports WATCH only. Neutral means incomplete alignment without direct contradiction; Conflicted means Weekly or 4H directly opposes confirmed Daily. Adds no `request.security()` calls and does not own confidence, entries, execution, alerts, trade management, or presentation. |
...
| KR-360 | Confidence Engine | Synthesizes prior public outputs into explainable confidence. | `1.0.0` | `FROZEN` | Frozen | Public outputs from KR-341 consolidated direction plus KR-310, KR-315, KR-320, KR-330, KR-340, and KR-350; KR-335 and KR-345 are not consumed in this release | Confidence readiness, 0-100 score, state/text/reason, classification flags | KR-370; KR-380; KR-705 | Static review confirms score clamping and public-output-only architecture. Source and repository history agree on Frozen. KR-341 now provides directional authority without changing the KR-360 public contract. |

## Decision, Execution, Trade Management, Alerts, and Interface

| Engine | Name | Single responsibility | Source version | Source status | Contract maturity | Inputs / dependencies | Public outputs summary | Downstream consumers | Validation scope and notes |
|---|---|---|---|---|---|---|---|---|---|
| KR-370 | Decision Engine | Decides direction and readiness: AVOID, WAIT, WATCH, BUY READY, or SELL READY. | `1.0.0` | `FROZEN` | Frozen | Public `out...` outputs from prior intelligence engines, with KR-341 as directional authority | Decision readiness/state/text/reason, blocker, next review, dynamic checklist, exclusive state flags | KR-380; KR-705 | Source header records validation on Copper, Silver, and Gold. It does not trigger entries. KR-341 now gates final BUY READY / SELL READY direction without changing the KR-370 public contract. |
