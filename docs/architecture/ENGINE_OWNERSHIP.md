...
| KR-252 | What cash market, sector index, parent index, or global reference influences this instrument? | Market relationship configuration only | Support/model classification, market-data retrieval, relative strength, decisions, or alerts | KR-251 support/model outputs; KR-250 current asset identity | Relationship readiness/status/reason, cash/global/sector/parent symbols, and context flags | Future relationship-aware engines; not wired into KR-260 yet |
