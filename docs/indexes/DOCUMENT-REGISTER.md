...
| EAS-001 | Engineering Architecture Framework | Engineering | P0 | Draft | Engineering Architect | `docs/engineering/eap/EAS-001-ENGINEERING-ARCHITECTURE-FRAMEWORK.md` | Version 0.1 Draft; completion and review authorized; not approved; not canonical |
| EAS-002 | Repository Engineering Standards | Engineering | P0 | Draft | Engineering Architect | `docs/engineering/eap/EAS-002-REPOSITORY-ENGINEERING-STANDARDS.md` | Version 0.1 Draft; completion and review authorized; not approved; not canonical |
